...
mod tests {
    ...
    fn test_hash() {
        let x = vec![1, 2, 3];
        let result = hash(&x);
        assert_eq!(result, vec![0x03, 0x90, 0x58, 0xc6, 0xf2, 0xc0, 0xcb, 0x49, 0x2c, 0x53, 0x3b, 0x0a, 0x4d, 0x14, 0xef, 0x77, 0xcc, 0x0f, 0x78, 0xab, 0xcc, 0xce, 0xd5, 0x28, 0x7d, 0x84, 0xa1, 0xa2, 0x01, 0x1c, 0xfb, 0x81]);
    }
    ...
    fn test_merkelize() {
        ...
        assert_eq!(result[1], vec![0xbe, 0xd3, 0xd3, 0x3a, 0x81, 0x02, 0x6f, 0x7b, 0xe9, 0x3a, 0xef, 0xad, 0x44, 0xc5, 0x89, 0x1c, 0x27, 0xfc, 0x82, 0x65, 0xaa, 0x15, 0x27, 0x9a, 0x58, 0xe2, 0x87, 0x74, 0x4b, 0x7c, 0x77, 0x53]);
        }
    
    #[test]
    fn test_get_root() {
        let tree = vec![vec![], vec![0xbe, 0xd3, 0xd3, 0x3a, 0x81, 0x02, 0x6f, 0x7b, 0xe9, 0x3a, 0xef, 0xad, 0x44, 0xc5, 0x89, 0x1c, 0x27, 0xfc, 0x82, 0x65, 0xaa, 0x15, 0x27, 0x9a, 0x58, 0xe2, 0x87, 0x74, 0x4b, 0x7c, 0x77, 0x53]];
        let result = get_root(&tree);
        assert_eq!(result, vec![0xbe, 0xd3, 0xd3, 0x3a, 0x81, 0x02, 0x6f, 0x7b, 0xe9, 0x3a, 0xef, 0xad, 0x44, 0xc5, 0x89, 0x1c, 0x27, 0xfc, 0x82, 0x65, 0xaa, 0x15, 0x27, 0x9a, 0x58, 0xe2, 0x87, 0x74, 0x4b, 0x7c, 0x77, 0x53]);
    }
